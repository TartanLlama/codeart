        ...
        def generate(site)
          ...
          site.pages.each do |page|
            if page.name == '404.html'
              new_pages << page
            elsif page.name.end_with?('.md')
            page.data['theme'] = 'dark'
            page.data['font'] = 'mono'
            page.data['themefolder'] = ''

            path = File.dirname(page.dir)

            light_mono_page = Jekyll::Page.new(site, site.source, path, page.name)
            puts()
            ...
            light_prop_page = Jekyll::Page.new(site, site.source, path, page.name)
            ...
            dark_prop_page = Jekyll::Page.new(site, site.source, path, page.name)
